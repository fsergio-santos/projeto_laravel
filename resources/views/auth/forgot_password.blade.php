                        ...
                        <table border="0" cellpadding="20" cellspacing="0" style="width:100%;padding-bottom:0px;">
                            ...
                            <tr>
                                <td style="padding: 0 0 20px 0;text-align:center;color:#334150;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">
                                    Solicitação para alterar sua senha.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 0 0 20px 0;">
                                    <a target="_blank" href="{{$link}}"
                                       style="background-color: #5C7CE5;color:#fff;padding:15px 40px;font-size: 15px;font-family: 'Lato', sans-serif;font-weight:800;width: 140px;display: block;margin:0 auto;border-radius:5px;">Reset
                                        Sua Senha</a>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 20px 0 20px 0;text-align:center;color:#7F8FA4;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">
                                    Se você não solicitou essa ação ignore esse e-mail. Caso contrário, <br/>
                                    por favor click no botão para alterar sua senha.
                                </td>
                            </tr>
                            <tr>
