        ...
        <div class="tile">
            <div class="tile-body">
                <form>
                    ...
                    <div class="center" <button type="button" class="btn btn-danger btn-lg" id="showModal">Excluir Dados do
                        Autor</button>
                        <a href="{{ url('/author/cancelar') }}" class="btn btn-secondary ml-3 btn-lg">
                            Cancelar Exclusão do Autor
                        </a>
                    </div>
                </form>
            </div>
    ...
    <div class="modal modal-danger fade" id="myModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/author/excluir', $registro->id) }}" method="POST">
                    @csrf
