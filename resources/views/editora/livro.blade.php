...
@section('content')
    <div class="container">
        <div class="app-title">
            <h1>
                <i class="fa fa-edit">Lista de Livros por Editora</i>
            </h1>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-search fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="{{ url('/editora/listar') }}">Pesquisa de Editoras</a></li>
            </ul>
        </div>
        <div class="container">
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12">
                <div class="form-group form form-inline">
                    <label class="control-label col-sm-1">Editora:</label> <input type="text"
