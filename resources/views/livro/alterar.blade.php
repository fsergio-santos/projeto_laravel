        ...
        <div class="tile">
            <div class="tile-body">
                <form>
                    ...
                    <div class="center">
                        <button type="button" id="showModal" class="btn btn-primary btn-lg">Alterar Dados do Livro</button>
                        <a href="{{ url('/livro/cancelar') }}" class="btn btn-secondary ml-3 btn-lg">
                            Cancelar Alteração do Livro
                        </a>
                    </div>
                </form>
            </div>
    ...
    <div class="modal modal-success modal-save" id="myModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/livro/atualizar', $registro->id) }}" method="POST">
                    @csrf
