...
@section('content')
        ...
        <div class="tile">
            <div class="tile-body">
                <form>
                    ...
                    <div class="center">
                        <button type="button" id="showModal" class="btn btn-primary btn-lg">Alterar Dados da Permissão</button>
                        <a href="{{ url('/permissao/cancelar') }}" class="btn btn-secondary ml-3 btn-lg">
                            Cancelar Alteração da Permissão
                        </a>
                    </div>
                </form>
            </div>
    ...
    <div class="modal modal-success modal-save" id="myModal" tabindex="-1" permissao="dialog">
        <div class="modal-dialog" permissao="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Confirme a Alteração do Registro!</h4>
                </div>
                <form action="{{ url('/permissao/atualizar', $registro->id) }}" method="POST">
                    @csrf
