...
@section('content')
    ...
    <div class="container">
        <div class="app-title">
            <h1>
                <i class="fa fa-edit">Lista de Permissão</i>
            </h1>
        ...
        <div class="container">
            <div class="tile">
                <div class="tile-body">
                    <form class="form form-inline" action="{{ url('/permissao/buscar') }}" method="POST">
                        @csrf
                        <div class="col-sm-12">
                ...
                <div class="tile-body">
                    <div id="no-more-tables">
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Ação" style="text-align: center">
                                            <a class="btn btn-info btn-sm"
                                                href="{{ url('/permissao/alterar', $registro->id) }}"><i
                                                    class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm"
                                                href="{{ url('/permissao/deletar', $registro->id) }}"><i
                                                    class="fa fa-trash"></i>
                                            </a>
                                            <a class="btn btn-info btn-sm"
                                                href="{{ url('/permissao/consultar', $registro->id) }}"><i
                        ...
                        @else
                            {{ $registros->links() }}
                        @endif
                        <a class="btn btn-success btn-lg" href="{{ url('/permissao/incluir') }}">Inclui Nova Permissão
